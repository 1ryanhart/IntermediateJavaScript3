...
function runRace(raceID) {
	...
	const getraceInterval = setInterval(() => {
		...
		.then(res => {
			...
			if (res.status === "in-progress") {
				...
				clearInterval(getraceInterval) // to stop the interval from repeating
	...
	.catch('Error at runRace promise')
}
	...
	return `
		...
		<main id="two-columns">
			...
			<section id="accelerate">
				...
				<button id="gas-peddle" class="hidden">Click Me To Win!</button>
			</section>
		</main>
		<footer></footer>
	`
...
function startRace(id) {
	...
	.then(() => {
		let button = document.querySelector('#gas-peddle')
